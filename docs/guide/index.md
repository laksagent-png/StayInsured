...
There is no account, no subscription and no internet connection involved.
...
| Page | Covers |
| --- | --- |
| [Find your way around](getting-around.md) | The seven screens, search, the badges, and how to read the dashboard |
...
| [Settings](settings.md) | Agency details, the expiring-soon window, changing your password, reminder preferences |
...
- **Your book never leaves the machine.** The database is encrypted with your
  password. Nothing is uploaded, and no feature depends on being online.
